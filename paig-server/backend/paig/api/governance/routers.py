...
from api.governance.routes.ai_app_config_download_router import ai_app_config_download_router, ai_app_config_download_with_key_router
...
from api.governance.routes.ai_asset_router import ai_asset_router, stats_router
...
governance_router.include_router(stats_router, prefix="/v1/stats", tags=["Usage Statistics"])
